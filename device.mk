...
# HIDL interfaces the passthrough impls above link against. These are built from
# hardware/mediatek/interfaces/, not extracted -- adding them to
# proprietary-files.txt instead produces
#   base_rules.mk:338: error: vendor/itel/S666LN:
#     MODULE.TARGET.SHARED_LIBRARIES.vendor.mediatek.hardware.mtkpower@1.0
#     already defined by hardware/mediatek/interfaces/mtkpower/1.0
# because `prefer: true' on a cc_prebuilt_library_shared does not displace a
# module generated by hidl_interface. The source module simply was not being
# installed to /vendor; vendor.mediatek.hardware.mtkpower@1.2-impl.so needs the
# whole 1.0/1.1/1.2 chain.
PRODUCT_PACKAGES += \
